...
\usepackage{fontawesome} % สำหรับไอคอน (ถ้าต้องการ)
\usepackage{geometry} 
\usepackage{tikz} 
...
\setmainfont{THSarabun.ttf}[Scale=1.2, Path=./, UprightFont=*, BoldFont=* Bold, ItalicFont=* Italic, BoldItalicFont=* Bold Italic]
\XeTeXlinebreaklocale "th"
\XeTeXlinebreakskip = 0pt plus 1pt  % << เพิ่มอันนี้เข้าไป
