...
% ===============================
% Font configuration: TH Sarabun as main (for Thai text), Libertinus for English
% Since document is primarily Thai, use Thai font as main
% ===============================

% Set main font to TH Sarabun (Thai)
...
% Define English font family (use when needed for English sections)
\newfontfamily\englishfont{LibertinusSerif}[
Extension=.otf,
Path=./styles/,
UprightFont=*-Regular,
BoldFont=*-Bold,
...
% Command for English text: \texten{English text here}
\newcommand{\texten}[1]{{\englishfont #1}}
