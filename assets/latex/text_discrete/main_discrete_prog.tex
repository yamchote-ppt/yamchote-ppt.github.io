...
% Using polyglossia for proper multilingual support
% ===============================

% Main font for English: Libertinus Serif (serif font)
...
\newfontfamily\thaifont[Script=Thai, Scale=1.2, Path=./styles/]{THSarabun.ttf}
